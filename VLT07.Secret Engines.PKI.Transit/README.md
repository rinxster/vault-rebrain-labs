...
`echo hvs.CAESIBdOhNXjAkIMAsMMaB0bL9KWLBGx9NVJ7Azpbs-svzs9Gh4KHGh2cy5yc2tlcU42U0Z4MmVQUHViajgxR3FHcmU > /home/user/cert_issuer_token`
...
`CERT > /home/user/cert.pem` 
 ...
 curl \
    --header "X-Vault-Token: hvs.k0BzsDoTeG39pk3KoErIhsbU" \
    --request POST \
...
vault write my-int-ca/roles/client allow_server=false enforce_hostnames=false allow_client=true allow_any_name=true allow_bare_domains=true max_ttl=1440h
